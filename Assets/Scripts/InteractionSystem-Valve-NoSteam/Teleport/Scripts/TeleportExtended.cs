...
{
	//-------------------------------------------------------------------------
	public class TeleportExtended : MonoBehaviour
    {
		[SerializeField]
        ...
        */
		//-------------------------------------------------
		private static TeleportExtended _instance;
		public static TeleportExtended instance
		{
			get
			{
				if ( _instance == null )
				{
					_instance = GameObject.FindObjectOfType<TeleportExtended>();
				}
